  ...
  const testimonials = [
    {
      name: "Anil Nagwani",
      handle: "@AnilG",
      text: "Fortex AD Media transformed our social media. Their strategic campaigns significantly increased website traffic and sales. Highly recommended! Thanks, Fortex for your outstanding work!",
      hashtag: "#FortexAD",
    },
    {
    ...
    },
    {
      name: "Kamlesh Verma",
      handle: "@Mogli123",
      text: "Fortex AD Media exceeded our expectations. Their targeted ads and creative content significantly improved our brand awareness and customer acquisition. Amazing work!",
      hashtag: "#AdExcellence",
    },
    {
      name: "Ritesh Rai",
      handle: "@Raj patil raja",
